...
const AdvertisedItems = ({ data }) => {
    ...
    return (
        <div className='my-24'>
            ...
            <div className="carousel carousel-center w-8/12 mx-auto p-8 space-x-10 bg-gray-600 rounded-box border-4 border-yellow-500">
                    ...
                    data.map(item =>
                        <div key={item._id} className="carousel-item">
                            <div className="indicator">
                                ...
                                <img src={item.image} className="rounded-box" alt="" style={{ height: '350px', width: '250px' }} />
                            </div>
